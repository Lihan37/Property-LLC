...
export function Header() {
  ...
  return <header className={`site-header ${scrolled ? "scrolled" : ""}`}>
    <div className="container header-inner">
      <Link href="/" className="brand" aria-label={`${company.name} home`}><span className="brand-mark"><ShieldCheck size={25} /></span><span><b>PRO PROPERTY CARE</b><small>SOLUTIONS LLC</small></span></Link>
