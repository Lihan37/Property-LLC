...
export function Footer() {
  return <footer className="footer"><div className="container footer-grid">
    <div className="footer-brand"><Link href="/" className="brand brand-light"><span className="brand-mark"><ShieldCheck size={25} /></span><span><b>PRO PROPERTY CARE</b><small>SOLUTIONS LLC</small></span></Link><p>Dependable residential and commercial maintenance, repairs, turnovers, and grounds care—with one responsive point of contact.</p></div>
